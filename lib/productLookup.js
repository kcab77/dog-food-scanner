...
// Sources we consider OUR OWNED data (safe to serve as our own DB).
// smartscan = extracted from a user's ingredient-panel photo (fully ours);
// openfoodfacts = open-licensed; manual = hand-entered by us.
// NOT owned (never served as our DB): go-upc (licensed, use-only), sheet, legacy_unknown.
export const OWNED_SOURCES = ['smartscan', 'openfoodfacts', 'manual']
